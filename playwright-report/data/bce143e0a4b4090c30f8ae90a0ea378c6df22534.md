...
- Name: docs.spec.ts >> Warlock Package Documentation >> should display key features
- Location: tests\docs.spec.ts:17:7
...
Locator: getByText('WoW Midnight patch')
Expected: visible
Error: strict mode violation: getByText('WoW Midnight patch') resolved to 2 elements:
    1) <p>WoW Midnight Patch 12.0.x - Optimized Rotation Se…</p> aka getByText('WoW Midnight Patch 12.0.x -')
    2) <li>Optimized for WoW Midnight patch 12.0.x</li> aka getByText('Optimized for WoW Midnight')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('WoW Midnight patch')
...
- generic [ref=e2]:
  ...
  - contentinfo [ref=e57]:
    ...
    - paragraph [ref=e59]:
      - text: "GitHub:"
      - link "jordanellis8686-wq/warlock-gse3-midnight" [ref=e60]:
