...
- Name: docs.spec.ts >> Warlock Package Documentation >> should display all three specializations
- Location: tests\docs.spec.ts:9:7
...
Locator: getByText('Affliction')
Expected: visible
Error: strict mode violation: getByText('Affliction') resolved to 2 elements:
    1) <span class="badge">Affliction</span> aka getByRole('banner').getByText('Affliction')
    2) <h2>Affliction</h2> aka getByRole('heading', { name: 'Affliction' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Affliction')
